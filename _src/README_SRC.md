...
| `ITTS_OUT=<out> node _check18.js` | `CHECK18 OK: 53 tieu chi \| da ve 75 trang/tab` - **hội đồng audit tự động**: vẽ THẬT mọi trang/tab, mọi trang qua mắt 8 chức danh, cổng học viên qua mọi hồ sơ |
